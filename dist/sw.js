...
async function precache() {
  ...
  return cache.addAll(['/', '/index.html', '/assets/index.js', '/assets/MediaPlayer.js', '/assets/plugins/AutoPause.js', '/assets/plugins/AutoPlay.js', '/assets/index.css', '/assets/BigBuckBunny.mp4']);
}
